...
//                    ->add('timezone', TimezoneType::class, ['required' => false])
                ...
                ->end()
                ->with('Social')
                    ->add('facebookUid', null, ['required' => false, 'disabled' => true])
                    ->add('vkontakteUid', null, ['required' => false, 'disabled' => true])
                    ->add('odnoklassnikiUid', null, ['required' => false, 'disabled' => true])
                    ->add('googleUid', null, ['required' => false, 'disabled' => true])
                ->end()
            ->end()
            ->tab('Security')
                ->with('Status')
